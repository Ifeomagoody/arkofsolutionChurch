      ...
      <section>
        <div className='flex flex-wrap  lg:justify-around md:justify-start p-10 items-center'>
          ...
          <div className='upcoming-texts '>
              ...
              <button className=' text-xs transition duration-150 shadow-xl font-bold text-[#e7dada] rounded-full py-3 px-6 cursor-pointer bg-[#3b82f6f6] hover:bg-white hover:text-[#3b82f6f6]'>JOIN THIS SERMON</button>
          </div>
        </div>
      </section>
    </>
