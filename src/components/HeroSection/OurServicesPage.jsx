...
export default function OurServicesPage() {
  return (
    <section>
         <div className="bg-[#F5F0E9] flex py-10 justify-center items-center">
                 <div className='bg-white relative p-30 flex flex-col justify-center items-center w-[90%] mb-6 rounded-lg shadow'>
